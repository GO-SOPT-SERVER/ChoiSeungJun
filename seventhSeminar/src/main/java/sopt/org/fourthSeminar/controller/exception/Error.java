...
public enum Error {
    ...
    INVALID_MULTIPART_EXTENSION_EXCEPTION(HttpStatus.BAD_REQUEST, "잘못된 확장자입니다."),
    ...
    NOT_FOUND_SAVE_IMAGE_EXCEPTION(HttpStatus.NOT_FOUND, "저장할 이미지 파일이 없거나 문제가 발생하였습니다."),
